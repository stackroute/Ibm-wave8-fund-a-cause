...
public class CauseRepositoryTest {
    ...
    public void testSaveCause() {
        ...
        CauseCRUD fetchCause = causeRepository.findById(cause.getId()).get();
        Assert.assertEquals("f123", fetchCause.getId());

    }
    @Test
    public void testSaveCauseFailure() {
        CauseCRUD cause1 = new CauseCRUD("f123","relief","nan123","Floods","aa","21-01-2019" ,"Chennai");
    ...
    public void testGetAllCauses() {
        ...
        List<CauseCRUD> list = causeRepository.findAll();
