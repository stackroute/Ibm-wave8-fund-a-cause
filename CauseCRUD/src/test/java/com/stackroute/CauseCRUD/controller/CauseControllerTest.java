...
import com.stackroute.CauseCRUD.Controller.CauseCRUDController;
...
public class CauseControllerTest {
    ...
    private CauseCRUD cause;
    @MockBean
    private CauseCRUDService service;
    @InjectMocks
    private CauseCRUDController causeController;
    private List<CauseCRUD> list =null;
